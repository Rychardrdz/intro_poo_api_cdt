# Neste exemplo, focamos no 'TypeError', que acontece quando tentamos fazer contas com tipos que nao combinam.
...
class Celular:
    ...
    def fazer_chamada(self, custo_bateria):
        ...
        try:
            ...
            print(f"ERRO: O custo da bateria deve ser um número!")
        else:
